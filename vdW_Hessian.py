...
def calculate_vdW(i, j, rij, coordinates, atom_names):
    ...
    #C6i = C6_vdW[atom_names[i]] * (HARTREE_to_kcal_mol * BOHR_to_angstr ** 6) 
    #C6j = [C6_vdW[atom_names[a]] * (HARTREE_to_kcal_mol * BOHR_to_angstr ** 6) for a in j]
    ...
    #alphai = ALPHA_vdW[atom_names[i]]  * (BOHR_to_angstr ** 3)
    #alphaj = [ALPHA_vdW[atom_names[a]] * (BOHR_to_angstr ** 3) for a in j]
